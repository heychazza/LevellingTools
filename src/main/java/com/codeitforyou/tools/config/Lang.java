...
public enum Lang {
    ...
    GIVE_LEVEL_COMMAND_SELF("{0} &7You've given yourself an extra &e{1} &7level(s)."),
    GIVE_LEVEL_COMMAND_OTHER("{0} &7You've given &6{1} &7an extra &e{1} &7level(s)."),
    GIVE_LEVEL_COMMAND_ALL("{0} &7You've given &6{1} &7online players an extra &e{2} &7level(s)."),
    PROGRESS_START("&8["),
    PROGRESS_CHARACTER(":"),
    PROGRESS_END("&8]"),
    ...
    public static boolean init(Tools Tools) {
        Lang.c = Tools.getConfig();
